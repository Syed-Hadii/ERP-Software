...
const FinanceDashboard = () => {
        ...
        datasets: [
            {
                ...
                data: dashboardData.topInventoryItems.map((item) => item.totalCost) || [],
    ...
    return (
        <Wrapper.Box sx={{ minHeight: "100vh", bgcolor: "grey.100", p: { xs: 2, md: 4 } }}>
            {/* Header */}
            <Wrapper.Box
                sx={{
                    display: "flex",
                ...
                {loading
                    ...
                    : [
                        ...
                        <Wrapper.Grid item xs={12} sm={6} lg={4} key={index}>
                            ...
                            >
                                <Wrapper.Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                                    {item.icon}
                ...
                <Wrapper.Grid container spacing={2} sx={{ mb: 4 }}>
                    ...
                    <Wrapper.Grid item xs={12} lg={4}>
                        <Wrapper.Paper sx={{ bgcolor: "white", boxShadow: 3, p: 2 }}>
                            ...
                            <Wrapper.Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                                <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                    Total Items: <strong>{dashboardData.inventorySummary.totalItems}</strong>
                                </Wrapper.Typography>
                                <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                    Total Quantity: <strong>{dashboardData.inventorySummary.totalQty}</strong>
                                </Wrapper.Typography>
                                <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                    Total Value: <strong>PKR {dashboardData.inventorySummary.totalValue.toLocaleString()}</strong>
                                </Wrapper.Typography>
                            </Wrapper.Box>
                        </Wrapper.Paper>
                    </Wrapper.Grid>
                    ...
                    <Wrapper.Grid item xs={12} lg={4}>
                        <Wrapper.Paper sx={{ bgcolor: "white", boxShadow: 3, p: 2 }}>
                            ...
                            <Wrapper.Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                                <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                    Total Customers: <strong>{dashboardData.customerSummary.totalCustomers}</strong>
                                </Wrapper.Typography>
                                <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                    Total Receivables: <strong>PKR {dashboardData.customerSummary.totalBalance.toLocaleString()}</strong>
                                </Wrapper.Typography>
                            </Wrapper.Box>
                        </Wrapper.Paper>
                    </Wrapper.Grid>
                    ...
                    <Wrapper.Grid item xs={12} lg={4}>
                        <Wrapper.Paper sx={{ bgcolor: "white", boxShadow: 3, p: 2 }}>
                            ...
                            <Wrapper.Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                                <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                    Total Suppliers: <strong>{dashboardData.supplierSummary.totalSuppliers}</strong>
                                </Wrapper.Typography>
                                <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                    Total Payables: <strong>PKR {dashboardData.supplierSummary.totalBalance.toLocaleString()}</strong>
                                </Wrapper.Typography>
                            </Wrapper.Box>
                        </Wrapper.Paper>
                    </Wrapper.Grid>
                                ...
                                <Wrapper.Table>
                                    <Wrapper.TableHead>
                                        <Wrapper.TableRow sx={{ bgcolor: "grey.100" }}>
                                            <Wrapper.TableCell sx={{ fontWeight: "bold", fontSize: "0.75rem", textTransform: "uppercase" }}>
                                                Date
                                            </Wrapper.TableCell>
                                            <Wrapper.TableCell sx={{ fontWeight: "bold", fontSize: "0.75rem", textTransform: "uppercase" }}>
                                                Type
                                            ...
                                            <Wrapper.TableCell sx={{ fontWeight: "bold", fontSize: "0.75rem", textTransform: "uppercase", textAlign: "right" }}>
                                                Amount
                                            </Wrapper.TableCell>
                                            <Wrapper.TableCell sx={{ fontWeight: "bold", fontSize: "0.75rem", textTransform: "uppercase", textAlign: "right" }}>
                                                Status
                                    ...
                                    <Wrapper.TableBody>
                                        {dashboardData.recentTransactions.length > 0 ? (
                                            dashboardData.recentTransactions.map((tx, index) => (
                                                ...
                                                >
                                                    <Wrapper.TableCell>{new Date(tx.date).toLocaleDateString()}</Wrapper.TableCell>
                                                    <Wrapper.TableCell>{tx.type || "N/A"}</Wrapper.TableCell>
                                                    <Wrapper.TableCell>{tx.reference || "N/A"}</Wrapper.TableCell>
                                                    <Wrapper.TableCell>{tx.description || "N/A"}</Wrapper.TableCell>
                                                    <Wrapper.TableCell sx={{ textAlign: "right", color: "success.main" }}>
                                                        PKR {(tx.amount || 0).toLocaleString()}
                                                    </Wrapper.TableCell>
                                                    <Wrapper.TableCell sx={{ textAlign: "right" }}>{tx.status || "N/A"}</Wrapper.TableCell>
                                                </Wrapper.TableRow>
                                            ))
                                        ) : (
                                            <Wrapper.TableRow>
                                                <Wrapper.TableCell colSpan={6} sx={{ textAlign: "center", color: "grey.600" }}>
                                    ...
                                    <Wrapper.TableBody>
                                        {dashboardData.recentWriteOffs.length > 0 ? (
                                            dashboardData.recentWriteOffs.flatMap((wo, index) =>
                                                (wo.items || []).map((item, i) => (
                                                    <Wrapper.TableRow key={`${index}-${i}`} sx={{ "&:hover": { bgcolor: "grey.50" } }}>
                                                        <Wrapper.TableCell>{new Date(wo.date).toLocaleDateString()}</Wrapper.TableCell>
                                                        <Wrapper.TableCell>{wo.reference || "N/A"}</Wrapper.TableCell>
                                                        <Wrapper.TableCell>{item.itemName || "N/A"} ({item.itemCode || "N/A"})</Wrapper.TableCell>
                                                        <Wrapper.TableCell sx={{ textAlign: "right" }}>{item.quantity || 0}</Wrapper.TableCell>
                                                    </Wrapper.TableRow>
                                                ))
                                            )
                                        ) : (
                                            <Wrapper.TableRow>
                                                <Wrapper.TableCell colSpan={4} sx={{ textAlign: "center", color: "grey.600" }}>
                                                    No write-offs found
                                                </Wrapper.TableCell>
                                            </Wrapper.TableRow>
                                        )}
                ...
                <Wrapper.Paper sx={{ bgcolor: "white", boxShadow: 3, mb: 4, p: 2 }}>
                    ...
                    <Wrapper.Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
                        ...
                        {dashboardData.currentPeriod.startDate && (
                            <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                Start: <strong>{new Date(dashboardData.currentPeriod.startDate).toLocaleDateString()}</strong>
                            </Wrapper.Typography>
                        )}
                        {dashboardData.currentPeriod.endDate && (
                            <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                End: <strong>{new Date(dashboardData.currentPeriod.endDate).toLocaleDateString()}</strong>
                            </Wrapper.Typography>
                        )}
                    </Wrapper.Box>
                </Wrapper.Paper>
            ...
            <Wrapper.Modal open={modalOpen} onClose={() => setModalOpen(false)}>
                ...
                >
                    ...
                    <Wrapper.Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                        <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                            <strong>Date:</strong>{" "}
                            {transactionDetails ? new Date(transactionDetails.date).toLocaleDateString() : "N/A"}
                        </Wrapper.Typography>
                        <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                            <strong>Type:</strong> {transactionDetails?.type || "N/A"}
                        </Wrapper.Typography>
                        <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                            <strong>Reference:</strong> {transactionDetails?.reference || "N/A"}
                        </Wrapper.Typography>
                        <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                            <strong>Description:</strong> {transactionDetails?.description || "N/A"}
                        </Wrapper.Typography>
                        ...
                        {transactionDetails?.bankAccount && (
                            <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                ...
                                {transactionDetails.bankAccount.bankName || "N/A"} ({transactionDetails.bankAccount.accountNumber || "N/A"})
                            </Wrapper.Typography>
                        )}
                        {transactionDetails?.cashAccount && (
                            <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                <strong>Cash Account:</strong> {transactionDetails.cashAccount || "N/A"}
                            </Wrapper.Typography>
                        )}
                        <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                        ...
                        <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                            <strong>Total Amount:</strong> PKR {(transactionDetails?.totalAmount || 0).toLocaleString()}
                        </Wrapper.Typography>
                        <Wrapper.Typography variant="body2" sx={{ color: "grey.600" }}>
                                        ...
                                        <Wrapper.TableBody>
                                            {(transactionDetails.accounts || []).map((acc, index) => (
                                                <Wrapper.TableRow key={index}>
                                                    <Wrapper.TableCell>{acc.accountName || "N/A"}</Wrapper.TableCell>
                                                    <Wrapper.TableCell sx={{ textAlign: "right", color: "success.main" }}>
                                                        {acc.debit ? `PKR ${acc.debit.toLocaleString()}` : "-"}
                                                    </Wrapper.TableCell>
                                                    <Wrapper.TableCell sx={{ textAlign: "right", color: "error.main" }}>
                                                        {acc.credit ? `PKR ${acc.credit.toLocaleString()}` : "-"}
                                                    </Wrapper.TableCell>
                                                    <Wrapper.TableCell>{acc.narration || "N/A"}</Wrapper.TableCell>
                                                </Wrapper.TableRow>
                                            ))}
                                        </Wrapper.TableBody>
                                    </Wrapper.Table>
                                        ...
                                        <Wrapper.TableBody>
                                            {(transactionDetails.items || []).map((item, index) => (
                                                <Wrapper.TableRow key={index}>
                                                    ...
                                                    <Wrapper.TableCell sx={{ textAlign: "right" }}>{item.discount ? `${item.discount}%` : "-"}</Wrapper.TableCell>
                                                </Wrapper.TableRow>
                                            ))}
                                        </Wrapper.TableBody>
                                    </Wrapper.Table>
                    ...
                    <Wrapper.Box sx={{ mt: 2, display: "flex", justifyContent: "flex-end" }}>
                        <Wrapper.Button
                            variant="contained"
                            color="primary"
            ...
            <Wrapper.Modal open={closingModalOpen} onClose={() => !closingInProgress && setClosingModalOpen(false)}>
                <Wrapper.Box
                    sx={{
                        position: "absolute",
                        top: "50%",
                ...
                >
                    ...
                    <Wrapper.Alert severity="warning" sx={{ mb: 2 }}>
                        This action will close the accounting period and update account balances. Ensure all transactions are recorded.
                    </Wrapper.Alert>
                    <Wrapper.TextField
                        type="date"
                        value={periodEndDate}
                        ...
                        sx={{ mb: 2 }}
                    />
                    <Wrapper.Box sx={{ display: "flex", justifyContent: "flex-end", gap: 1 }}>
                        <Wrapper.Button
                            variant="outlined"
                            color="error"
                        ...
                        <Wrapper.Button
                            ...
                            startIcon={closingInProgress ? <Wrapper.CircularProgress size={20} /> : <Lock />}
                            sx={{ textTransform: "none" }}
                        >
